...
select location, date, max(total_cases) as max_total_cases,population, max((total_cases/population))*100 as infected_percentage
from portfolio1..['covid deaths$']
...
-- death percentage for total covid cases
